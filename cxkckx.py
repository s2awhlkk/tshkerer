...
try:
	...
	Info = "CaRLoS"	
if ":" not in Info:
	token = "7254654194:AAGhaE0rurvN3ODyj7LBoCyzGWQ1vIaoQyM";reqtoken = requests.get(f"https://api.telegram.org/bot{token}/getme").json();req = reqtoken["ok"]
	if req == True:
		id = "6865308476"
...
SaiF = types.InlineKeyboardButton(text = "- Me ☬ .", url = 'https://t.me/lhjjji')
channel = types.InlineKeyboardButton(text = "- 𝖬𝖾  .", url = 'https://t.me/lhjjji')
